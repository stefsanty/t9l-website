 ...
 *   `prisma/migrations/20260518000000_match_event_guest_flags_drop_guest_pseudo_players/migration.sql`;
 ...
 *   2. Player rows where id LIKE 'p-guest%' (≤5 rows — 4 per-team
 *      `p-guest-<lt-id>` + 1 legacy single `p-guest`).
 *
