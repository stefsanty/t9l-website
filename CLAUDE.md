...
| 12.5 (chore — backfill PR 12 ledger row + capture cold/warm timings) | TBD (filled post-merge) | (no rollback tag — docs-only) | unchanged from PR 12 | N/A | N/A |
