...
| 3 (toggle UI + RSVP dual-write) | `<TBD post-merge>` | `v-pre-pr-4-toggle-flip` (rollback target for PR 4 — the operational flip) | `<TBD post-deploy>` | `pre-pr-3-toggle` (`br-dry-silence-aojekuoy`) is the rollback target. PR 3's pre-merge testing exercises the per-PR Neon branch the integration auto-provisions for `feat/migration-3-toggle` (Setting seed migration verified applied; both rows present). | **First Sheets snapshot** — Drive file `1c5BoySUsC829gku_bm9JFZ7wIGgKxROJj29Q8XG_eRI` ("T9L Roster Snapshot 2026-04-28 pre-pr-3"), full URL `https://docs.google.com/spreadsheets/d/1c5BoySUsC829gku_bm9JFZ7wIGgKxROJj29Q8XG_eRI/edit`. Restore by copy-pasting cell ranges back into the live sheet `1BLTV9v518fEi3DXRA-qcYY3bLDm_qftNoY_5SNzjKSc`. |
