...
| 8 (Prisma-on-every-JWT perf fix — Upstash mapping cache) | _pending merge_ | `v-pre-pr-9-...` (next PR's rollback target) | _pending Vercel deploy_ | N/A — PR 8 is code-only, no schema change | N/A — PR 8 doesn't touch Sheets |
