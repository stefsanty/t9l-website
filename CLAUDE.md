...
| 9 (post-write pre-warm — closes the v1.2.3 invalidate-then-cold hole) | _(pending merge — fill in)_ | _(rollback target for PR 10 — to be created at next PR's merge)_ | _(pending — fill in)_ | N/A — PR 9 is code-only, no schema change | N/A — PR 9 doesn't touch Sheets |
