        ...
        <div className="p-7 pb-6 relative">
          ...
          <div className="mb-4">
            <h2 className="font-display text-4xl font-black uppercase tracking-tighter text-white leading-tight">
              {matchday.label} · {matchday.date ? formatShortDate(matchday.date) : 'TBD'}
            </h2>
            <a
              href={VENUE_MAP_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 text-[12px] font-bold text-white/40 hover:text-white/70 transition-colors mt-1 group/venue"
            >
              ...
              <span className="underline underline-offset-4 decoration-white/20 group-hover/venue:decoration-white/50">
                {VENUE_NAME} ↗
              </span>
            </a>
          </div>
              ...
              <div className="pt-2 flex items-center gap-2">
                ...
                <div className="text-center">
                  <span className="text-[10px] font-black uppercase tracking-widest text-white/20">
                    Sitting out: <span className="text-white/40">{sittingOutTeam.name}</span>
                  </span>
