...
import { ChevronRight, Plus, Pencil, Trash2, Upload } from 'lucide-react'
  ...
  return (
    <div>
      ...
      <div className="bg-admin-surface rounded-xl border border-admin-border overflow-hidden">
        {/* Table header */}
        <div className="grid text-admin-text3 text-xs uppercase tracking-wider px-4 py-2.5 border-b border-admin-border bg-admin-surface2"
        ...
        {/* Add Matchday inline form */}
        {showAddMatchday && (
          <form
            onSubmit={handleAddMatchday}
            className="px-4 py-3 border-t border-admin-border flex items-center gap-3"
          >
            <span className="font-condensed font-bold text-admin-text text-sm shrink-0">
              MD{(gameWeeks[gameWeeks.length - 1]?.weekNumber ?? 0) + 1}
            </span>
            <input
              name="startDate"
              type="date"
              required
              className="bg-admin-surface3 border border-admin-border text-admin-text text-sm rounded px-3 py-1.5 font-mono"
              placeholder="Date"
            />
            <select
              name="venueId"
              className="bg-admin-surface3 border border-admin-border text-admin-text text-sm rounded px-3 py-1.5 flex-1"
            >
