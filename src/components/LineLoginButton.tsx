        ...
        <div className="absolute right-0 top-full mt-2 w-52 bg-[#0F0311] border border-white/10 rounded-2xl overflow-hidden z-50 shadow-2xl">
          {needsSetup ? (
            <div className="px-4 py-3 border-b border-white/5">
              <p className="text-[10px] font-black uppercase tracking-widest text-vibrant-pink">Setup required</p>
              <p className="text-xs text-white/50 mt-0.5">Pick your player profile</p>
            </div>
          ) : (
            <div className="px-4 py-3 border-b border-white/5">
