        ...
        <div className={`transition-opacity duration-500 ${isSittingOut ? 'opacity-40' : ''}`}>
          ...
          <div className="mt-4 text-center">
            <Link
              ...
              className="text-[10px] font-black uppercase tracking-[0.2em] text-fg-mid hover:text-vibrant-pink transition-colors inline-flex items-center justify-center gap-1.5"
              data-testid={`matchday-card-view-${matchday.id}`}
            >
              <span>View matchday</span>
