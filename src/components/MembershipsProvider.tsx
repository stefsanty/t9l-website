 ...
 * here; client components (`LeagueSwitcher`, `AccountMenuLeagueSwitch`) read
 * from context. The previous design lazy-loaded via `/api/me/memberships` on
 * dropdown open, which produced a visible flash for multi-league users. With
 * SSR hydration, the trigger renders on first paint with the correct
 * visibility decision (≥2 memberships → show; <2 → hide).
 *
