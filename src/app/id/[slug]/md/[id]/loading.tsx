/**
 * v1.59.0 — loading skeleton for `/id/[slug]/md/[id]` (canonical
 * per-matchday Dashboard route). Same shape as the league root since
 * the route renders the same Dashboard component with `initialMatchdayId`.
 */
